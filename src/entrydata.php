...
if (empty($_SESSION['pengguna_nama'])){
 ...
 if(isset($_POST['submit'])){
        ...
        $query = $connect->prepare("INSERT INTO obyek(obyek_nama, obyek_telp, obyek_alamat, obyek_latitude, obyek_longitude, obyek_foto)
        VALUES (:obyek_nama,:obyek_telp,:obyek_alamat,:obyek_latitude,:obyek_longitude,:obyek_foto)");
        ...
        // Jalankan perintah SQL
		 if( $query->execute())
		{
		 echo "<script>alert('Input Berhasil !',document.location.href='entrydata.php')</script>";
		}
		else
		{
		 echo "<script>alert('Input gagal !',document.location.href='admin.php')</script>";
		}
...
<title>GIS Kursus Mobil | Entry Data</title>
			 ...
			 <div class="row">
				<div class="col-lg-12">
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-arrow-down"></i> Input Data</li>
					</ol>
				</div>
			</div>
			 <div class="row">
						  ...
						  <?php
                              ...
                              <form class="form-horizontal " method="post" enctype="multipart/form-data">	
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-8">
                                          <input type="text" class="form-control" name="obyek_nama" placeholder="Masukkan Nama Tempat" required autofocus>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Telepon</label>
                                      <div class="col-sm-8">
                                          <input type="text" class="form-control" name="obyek_telp" placeholder="Masukkan Nomor Telpon" required>
                                      </div>
                                  </div>
								  <div class="form-group">
                                      <label class="col-sm-2 control-label">Latitude</label>
                                      <div class="col-sm-8">
                                          <input type="text"  class="form-control" name="obyek_latitude" placeholder="Masukkan Angka Latitude" required>
                                      </div>
                                  </div>
								   <div class="form-group">
                                      <label class="col-sm-2 control-label">Longitude</label>
                                      <div class="col-sm-8">
                                          <input type="text"  class="form-control" name="obyek_longitude" placeholder="Masukkan Angka Longitude" required>
                                      </div>
                                  </div>
								   <div class="form-group">
                                      <label class="col-sm-2 control-label" >Alamat</label>
                                      <div class="col-sm-8">
                                         <textarea class="from-control" cols="50" rows="5" name="obyek_alamat" placeholder="Masukkan Alamat" required></textarea>
                                      </div>
                                  </div>
								  <div class="form-group">
