  	...
  	<div class="pmd-card card-default pmd-z-depth">
		<div class="login-card">
			<form action="ceklogin.php" method="post">
				<div class="pmd-card-title card-header-border text-center">
					<div class="loginlogo">
						<a href="javascript:void(0);"><img src="themes/images/icon1.png" alt="Logo"></a>
					</div>
					<h3>Sign In <span>with <strong>GIS Kursus Mobil</strong></span></h3>
				</div>
				...
				<div class="pmd-card-body">
                    ...
                    <div class="form-group pmd-textfield pmd-textfield-floating-label">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="pengguna_nama" class="form-control" id="exampleInputAmount">
                        </div>
                    </div>
                    ...
                    <div class="form-group pmd-textfield pmd-textfield-floating-label">
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" name="pengguna_password" class="form-control" id="exampleInputAmount">
                        </div>
                    </div>
                </div>
		...
		<div class="register-card">
			<div class="pmd-card-title card-header-border text-center">
				...
				<h3>Sign Up <span>with <strong>GIS</strong></span></h3>
			</div>
			<form>	
			  <div class="pmd-card-body">
